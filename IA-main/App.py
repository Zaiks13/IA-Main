    ...
    def profundidad(self):
                ...
                if(cuenta == 0):
                    ...
                    if self.agente.posicionY+1 < len(self.mapa.laberinto[self.agente.posicionY]):
                        if self.mapa.laberinto[self.agente.posicionX][self.agente.posicionY+1].marcas["O"] == "O":
                            # if self.agente.dificultad[self.mapa.laberinto[self.agente.posicionX][self.agente.posicionY+1].terreno] != 0:
                            # self.right()
        ...
        def mover(nodoAnterior):
            ...
            if len(vecinos) == 1:
                ...
                if nodoAnterior in vecinos.values():
                    print("nodo Anterior está dentro de los vecinos")

                    # print(prioridad[x])
                    if prioridad[x] in vecinos.keys():
                        # print(prioridad[x])
                        if 'R' in vecinos.keys():
                            # print("R")
                            if nodoAnterior != vecinos['R']:
                                self.right()
                                vecinos.clear()
                        if 'L' in vecinos.keys():
                            # print("L")
                            if nodoAnterior != vecinos['L']:
                                self.left()
                                vecinos.clear()
                        if 'U' in vecinos.keys():
                            # print("U")
                            if nodoAnterior != vecinos['U']:
                                self.up()
                                vecinos.clear()
                        if 'D' in vecinos.keys():
                            # print("D")
                            if nodoAnterior != vecinos['D']:
                                self.down()
                                vecinos.clear()
                else:
